    ...
    return (
        <div className="min-h-screen bg-background">
                ...
                <div className="absolute bottom-0 left-0 right-0 z-20 pb-20 pt-32 bg-gradient-to-t from-black via-black/90 to-transparent">
                    <div className="container mx-auto px-4">
                        ...
                        >
                            ...
                            <h1 className="text-6xl md:text-9xl font-bebas font-bold text-white uppercase tracking-tighter leading-none mb-8 drop-shadow-2xl">
                                {getLoc(leader.name)}
                            </h1>

                            <div className="max-w-4xl overflow-x-auto border-t border-white/10 pt-8 [&::-webkit-scrollbar]:h-1.5 [&::-webkit-scrollbar-thumb]:bg-white/30 [&::-webkit-scrollbar-track]:bg-transparent">
                                <div className="grid min-w-[560px] grid-cols-3 gap-8">
                                    <div>
                                        <span className="block text-zinc-500 font-bebas text-sm tracking-widest uppercase mb-1">Status</span>
                                        <span className="text-2xl text-white font-bebas tracking-wide uppercase">{leader.status}</span>
                                    </div>
                                    <div>
                                        <span className="block text-zinc-500 font-bebas text-sm tracking-widest uppercase mb-1">Era</span>
                                        <span className="text-2xl text-white font-bebas tracking-wide">{getLoc(leader.years)}</span>
                                    </div>
                                    <div>
                                        <span className="block text-zinc-500 font-bebas text-sm tracking-widest uppercase mb-1">Affiliation</span>
                                        <span className="text-2xl text-white font-bebas tracking-wide">{getLoc(leader.party)}</span>
                                    </div>
                                </div>
                            </div>
                        </motion.div>
            ...
            <section className="container mx-auto px-4 py-24">
                <div className="overflow-x-auto pb-2 [&::-webkit-scrollbar]:h-1.5 [&::-webkit-scrollbar-thumb]:bg-border/80 [&::-webkit-scrollbar-track]:bg-transparent">
                    <div className="grid min-w-[980px] grid-cols-12 gap-16">
                        ...
                        <div className="col-span-5">
                            ...
                            >
                                ...
                                <div className="space-y-8 relative">
                                    ...
                                    {leader.timeline && leader.timeline.map((item, index) => (
